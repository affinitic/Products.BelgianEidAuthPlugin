# -*- coding: utf-8 -*-
#
# File: BaseBelgianEidAuthPluginTestCase.py
#
...
class BaseBelgianEidAuthPluginTestCase(testcase):
    ...
    ##/code-section class-header_BaseBelgianEidAuthPluginTestCase
...
def test_suite():
    ...
    suite = TestSuite()
    suite.addTest(makeSuite(BaseBelgianEidAuthPluginTestCase))
    return suite
